...
Cwfolders::CreateTargetFrame(LPCOLESTR pszTargetName, LPUNKNOWN /*IN,OUT*/ *ppunk)
{
    ...
    if (NULL == *ppunk) {
#ifndef  UNIX
        hr = CoCreateInstance(CLSID_InternetExplorer, NULL, CLSCTX_LOCAL_SERVER, IID_IUnknown, (LPVOID*)ppunk);
#else
        hr = CoCreateInternetExplorer(IID_IUnknown, CLSCTX_LOCAL_SERVER | CLSCTX_INPROC_SERVER, (LPVOID*)ppunk);
#endif
    }
